defmodule PetalIgniter.SlideOverTest do
  use ComponentCase
  import PetalIgniter.SlideOver
  import PetalIgniter.Button
  import PetalIgniter.Form
      ...
      <.slide_over title="SlideOver" origin="left">
        <div class="gap-5 text-sm">
          ...
          <div class="flex justify-end">
            <.button label="close" phx-click={PetalIgniter.SlideOver.hide_slide_over("left")} />
          </div>
        </div>
      </.slide_over>
      """)
    ...
    html =
      ...
      <.slide_over origin="right" title="SlideOver">
        <div class="gap-5 text-sm">
          <.form_label label="Add some text here." />
          <div class="flex justify-end">
            <.button label="close" phx-click={PetalIgniter.SlideOver.hide_slide_over("right")} />
          </div>
        </div>
      </.slide_over>
      """)
    ...
    html =
      ...
      <.slide_over origin="top" title="SlideOver">
        <div class="gap-5 text-sm">
          <.form_label label="Add some text here." />
          <div class="flex justify-end">
            <.button label="close" phx-click={PetalIgniter.SlideOver.hide_slide_over("top")} />
          </div>
        </div>
      </.slide_over>
      """)
    ...
    html =
      ...
      <.slide_over origin="bottom" title="SlideOver">
        <div class="gap-5 text-sm">
          <.form_label label="Add some text here." />
          <div class="flex justify-end">
            <.button label="close" phx-click={PetalIgniter.SlideOver.hide_slide_over("bottom")} />
          </div>
        </div>
      </.slide_over>
      """)
