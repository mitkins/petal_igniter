defmodule <%= @module_prefix %>.Dropdown do
  ...
  def dropdown(assigns) do
    ...
    <div
      {@rest}
      {js_attributes("container", @options_container_id)}
  ...
  defp js_attributes("container", _options_container_id) do
    %{
      "x-data": "{open: false}",
  ...
  defp js_attributes("button",  _options_container_id) do
    %{
      "@click": "open = !open",
      "@click.outside": "open = false",
  ...
  defp js_attributes("options_container", _options_container_id) do
    %{
      "x-cloak": true,
      "x-show": "open",
  ...
  <% else %>
  defp js_attributes("container", options_container_id) do
    hide =
      JS.hide(
  ...
  defp js_attributes("button", options_container_id) do
    %{
      "phx-click":
        JS.toggle(
          to: "##{options_container_id}",
